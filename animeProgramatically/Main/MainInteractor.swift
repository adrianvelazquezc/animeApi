...
extension MainInteractor: MainInteractorProtocol {
    ...
    func getListUrl(){
        getUrl { responseInfo, responseCode, responseError in
    ...
    func getUrl(completionHandler:@escaping(PicturesDetailResponse?,Int?,Error?)->Void){
            let urlString = "https://api.waifu.pics/sfw/neko"
